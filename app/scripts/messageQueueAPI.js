// Program: messageQueueAPI.js
// Purpose: Platform REST API to send heart-beat and telemetry data to Message Queue
// Author:  Ray Lai
// Updated: Sep 12, 2016
// License: MIT license
//
module.exports = function(app, bodyParser, fs, syslogger, logger, helper) {
  ...
  console.log("/messageQueueAPI.js RabbitMQ API loaded.");

  /**
  * @api {post} /services/v1/simulation/messaging/telemetry/kubos/:topic/:nTimes  telemetry/topic/numberOfItems
  * @apiVersion 0.1.0
  * @apiName postTelemetrySimulation(topic, numberOfItems)
  * @apiDescription send to MQ with numberOfItems of telemetry data points 
  * @apiGroup Telemetry
  *
  * @apiParam {String} topic   RabbitMQ topic, e.g. kubos.telemetry, iot.telemetry
  ...
  *
  * @apiSuccess {array} data array of telemetry data points (qx,qy,qz,ex,ey,ez,qw,temp,hum)
  *
  * @apiExample {curl} Example usage:
  * curl -X POST -H "Content-type: application/json" -d '{"_id":"56f3123e8caf28f687480f42","deviceId":"IBEX","time":1457640420,"qx":236294.1956,
  * "qy":116196.8879,"qz":-34379.67682,"ex":-0.675287,"ey":0.508343,"ez":0.434496}'
  * "qw": 0.8879,"hum":-34.67682,"temp":32.1
  *        http://localhost:3000/services/v1/simulation/messaging/kubos/telemetry/kubos.telemetry/3
  *
  * @apiSuccessExample Success-Response:
  *     HTTP/1.1 200 OK
  *     {"status":200,"message":"upsert position data points",
  * "data":[{"_id":"56f3123e8caf28f687480f42","deviceId":"IBEX","timestamp":1457640420,"qx":236294.1956,
  * "qy":116196.8879,"qz":-34379.67682,"ex":-0.675287,"ey":0.508343,"ez":0.434496}]}
  *
