...
// Purpose: AngularJS controller for IoT platform admin console
// Author:  Ray Lai
// Updated: Jun 10, 2016
// License: MIT license
...
app.controller('adminConsoleController', ['$scope', '$timeout', 'adminFactory', '$http',
  ...
  $scope.getAttitudeMetricsTrend = function() {
    ...
    .success(function(data, status) {
      ...
      $scope.dataAttitudeTrend = [ { key: "Telemetry", values:  tmpValues }];
      //console.log("getAttitudeMetricsTrend() status=" + status + "   $scope.data=" + JSON.stringify($scope.data));
    })
    .error(function(err) {
      console.error('Sorry, IoT platform cannot serve getTelemetry MetricsTrend() immediately. Please retry later.');
    });
  };
  ...
  $scope.getPositionMetricsTrend = function() {
    ...
    .error(function(err) {
      console.error('Sorry, IoT platform cannot serve getPositionMetricsTrend() immediately. Please retry later.');
    });
  };
  ...
  $scope.getVehicleMetricsTrend = function() {
    ...
    .error(function(err) {
      console.error('Sorry, IoT platform cannot serve getVehicleMetricsTrend() immediately. Please retry later.');
    });
  };
  ...
  $scope.getOrbitMetricsTrend = function() {
    ...
    .error(function(err) {
      console.error('Sorry, IoT platform cannot serve getOrbitMetricsTrend() immediately. Please retry later.');
    });
  };
  ...
  $scope.getAttitudeAll = function() {
    ...
    .error(function(err) {
      console.error('Sorry, IoT platform cannot serve getAttitudeAll() immediately. Please retry later.');
    });
  };
  ...
  $scope.getAttitudePartial = function(vehicleId, nItems) {
    ...
    .error(function(err) {
      console.error('Sorry, IoT platform cannot serve getAttitudePartial() immediately. Please retry later.');
    });
  };
  ...
  $scope.getAttitudeFromTo = function(vehicleId, fromTS, toTS) {
    ...
    .error(function(err) {
      console.error('Sorry, IoT platform cannot serve getAttitudeFromTo() immediately. Please retry later.');
    });
  };
  ...
  $scope.getPositionAll = function() {   
    ...
    .error(function(err) {
      console.error('Sorry, IoT platform cannot serve getPositionAll() immediately. Please retry later.');
    });
  };
  ...
  $scope.getPositionPartial = function(vehicleId, nItems) {
    ...
    .error(function(err) {
      console.error('Sorry, IoT platform cannot serve getPositionPartial() immediately. Please retry later.');
    });
  };
  ...
  $scope.getPositionFromTo = function(vehicleId, fromTS, toTS) {
    ...
    .error(function(err) {
      console.error('Sorry, IoT platform cannot serve getPositionFromTo() immediately. Please retry later.');
    });
  };
  ...
  $scope.getVehicleAll = function() {
    ...
    .error(function(err) {
      console.error('Sorry, IoT platform cannot serve getVehicleAll() immediately. Please retry later.');
    });
  };
  ...
  $scope.getVehiclePartial = function(vehicleId, nItems) {
    ...
    .error(function(err) {
      console.error('Sorry, IoT platform cannot serve getVehiclePartial() immediately. Please retry later.');
    });
  };
  ...
  $scope.getVehicleFromTo = function(vehicleId, fromTS, toTS) {
    ...
    .error(function(err) {
      console.error('Sorry, IoT platform cannot serve getVehicleFromTo() immediately. Please retry later.');
    });
  };
  ...
  $scope.getOrbitAll = function() {
    ...
    .error(function(err) {
      console.error('Sorry, IoT platform cannot serve getOrbitAll() immediately. Please retry later.');
    });
  };
  ...
  $scope.getOrbitPartial = function(vehicleId, nItems) {
    ...
    .error(function(err) {
      console.error('Sorry, IoT platform cannot serve getOrbitPartial() immediately. Please retry later.');
    });
  };
  ...
  $scope.getOrbitFromTo = function(vehicleId, fromTS, toTS) {
    ...
    .error(function(err) {
      console.error('Sorry, IoT platform cannot serve getOrbitFromTo() immediately. Please retry later.');
    });
  };
  ...
  $scope.postAttitude = function(vehicleId, q1, q2, q3, q4) {
    ...
    .error(function(err) {
      console.error('Sorry, IoT platform cannot serve postAttitude() immediately. Please retry later.');
    });
  };
  ...
  $scope.postPosition = function(vehicleId, x, y, z, vx, vy, vz) {
    ...
    .error(function(err) {
      console.error('Sorry, IoT platform cannot serve postPosition() immediately. Please retry later.');
    });
  };
  ...
  $scope.postVehicle = function(vehicleId, deviceId, value, uom, alertHigh, warnHigh, 
    ...
    .error(function(err) {
      console.error('Sorry, IoT platform cannot serve postVehicle() immediately. Please retry later.');
    });
  };
  ...
  $scope.postOrbit = function(vehicleId, trajectory) {
    ...
    .error(function(err) {
      console.error('Sorry, IoT platform cannot serve postOrbit() immediately. Please retry later.');
    });
  };
  ...
  $scope.generateSimulatedTelemetry = function(telemetryDataType, nTimes) {
    if (telemetryDataType === 'attitude') {
      ...
      .error(function(err) {
        console.error('Sorry, IoT platform cannot serve generateAttitudeSimulated() immediately. Please retry later.');
      });
      ...
      .error(function(err) {
        console.error('Sorry, IoT platform cannot serve generatePositionSimulated() immediately. Please retry later.');
      });
      ...
      .error(function(err) {
        console.error('Sorry, IoT platform cannot serve generateVehicleSimulated() immediately. Please retry later.');
      });
      ...
      .error(function(err) {
        console.error('Sorry, IoT platform cannot serve generateOrbitSimulated() immediately. Please retry later.');
      });
    } else {
      console.error('Sorry, IoT platform cannot serve generateSimulatedTelemetry() immediately. Please retry later.');
    };
  };
  ...
  $scope.generateSimulatedTelemetryMQ = function(telemetryDataType, topic, nTimes) {
    if (telemetryDataType === 'attitude') {
      ...
      .error(function(err) {
        console.error('Sorry, IoT platform cannot serve generateAttitudeSimulatedMQ() immediately. Please retry later.');
      });
    } else if (telemetryDataType === 'position') {
      ...
      .error(function(err) {
        console.error('Sorry, IoT platform cannot serve generatePositionSimulatedMQ() immediately. Please retry later.');
      });
    } else if (telemetryDataType === 'vehicle') {
      ...
      .error(function(err) {
        console.error('Sorry, IoT platform cannot serve generateVehicleSimulatedMQ() immediately. Please retry later.');
      });
    } else if (telemetryDataType === 'orbit') {
      ...
      .error(function(err) {
        console.error('Sorry, IoT platform cannot serve generateOrbitSimulatedMQ() immediately. Please retry later.');
      });
    } else {
      console.error('Sorry, IoT platform cannot serve generateSimulatedTelemetry() immediately. Please retry later.');
    };
  ...
  $scope.postAttitudeMQ = function(topic, vehicleId, q1, q2, q3, q4) {
    ...
    .error(function(err) {
      console.error('Sorry, IoT platform cannot serve postAttitudeMQ() immediately. Please retry later.');
    });
  };
  ...
  $scope.postPositionMQ = function(topic, vehicleId, x, y, z, vx, vy, vz) {
    ...
    .error(function(err) {
      console.error('Sorry, IoT platform cannot serve postPositionMQ() immediately. Please retry later.');
    });
  };
  ...
  $scope.postVehicleMQ = function(topic, vehicleId, deviceId, value, uom, alertHigh, warnHigh, 
    ...
    .error(function(err) {
      console.error('Sorry, IoT platform cannot serve postVehicleMQ() immediately. Please retry later.');
    });
  };
  ...
  $scope.postOrbitMQ = function(topic, vehicleId, trajectory) {
    ...
    .error(function(err) {
      console.error('Sorry, IoT platform cannot serve postOrbitMQ() immediately. Please retry later.');
    });
  };
  ...
  $scope.cleanupDBCollection = function(collectionName) {
    ...
    .error(function(err) {
      console.error('Sorry, IoT platform cannot serve cleanupDBCollection() immediately. Please retry later.');
    });
  };
  ...
  $scope.getMetricsTotalAll = function(telemetryDataType) {
    ...
    .error(function(err) {
      console.error('Sorry, IoT platform cannot serve getMetricsTotalAll() immediately. Please retry later.');
    });
  };
  ...
  $scope.getMetricsAttitudeTotalByVehicle = function(telemetryDataType, vehicleId) {
    ...
    .error(function(err) {
      console.error('Sorry, IoT platform cannot serve getMetricsAttitudeTotalByVehicle() immediately. Please retry later.');
    });
  };
  ...
  $scope.getMetricsAttitudeTotalByVehicleTimestamp = function(telemetryDataType, vehicleId,
    ...
    .error(function(err) {
      console.error('Sorry, IoT platform cannot serve getMetricsAttitudeTotalByVehicleTimestamp() immediately. Please retry later.');
    });
  };
  ...
  $scope.getMetricsTrendTotalAll = function(telemetryDataType) {
    ...
    .error(function(err) {
      console.error('Sorry, IoT platform cannot serve getMetricsTrendTotalAll() immediately. Please retry later.');
    });
  };
  ...
  $scope.getMetricsTrendTotalN = function(telemetryDataType, nLimit) {
    ...
    .error(function(err) {
      console.error('Sorry, IoT platform cannot serve getMetricsTrendTotalN() immediately. Please retry later.');
    });
  };
  ...
  $scope.getMetricsTrendTotalByVehicle = function(telemetryDataType, vehicleId) {
    ...
    .error(function(err) {
      console.error('Sorry, IoT platform cannot serve getMetricsTrendTotalByVehicle() immediately. Please retry later.');
    });
  };
  ...
  $scope.getMetricsTrendTotalByVehicleN = function(telemetryDataType, vehicleId, nLimit) {
    ...
    .error(function(err) {
      console.error('Sorry, IoT platform cannot serve getMetricsTrendTotalByVehicleN() immediately. Please retry later.');
    });
  };
